...
def test_analysis_yields_word_occurrences():
    pass
...
'''
    ...
    actual_stopwords = set(w.token for w, r in analysis.ignored_words_with_reason.items() if r == WordIgnoreType.STOPWORD)
